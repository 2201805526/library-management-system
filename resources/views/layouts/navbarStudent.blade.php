    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('show.my.borrowings', $userID) }}">My Borrowings</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('show.my.history', $userID) }}">My Borrowing's History </a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('fines.index') }}">My Fines</a></li>
                @auth
                    <li class="nav-item">
